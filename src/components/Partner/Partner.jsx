...
import React from 'react';
 ...
 const Partner = () => {
    return (
        <div className='cta-block relative lg:h-[120px] h-[180px] mt-10'>
            <div className='bg-cta w-full h-full absolute top-0 left-0 z-[-1]'>
                <Image alt='partnet image' width={5000} height={5000} className='w-full h-full object-cover' src='/images/cta/bg-cta1.png' /> 
            </div>
